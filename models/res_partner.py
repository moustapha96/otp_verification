    ...
    def send_otp(self):
        for partner in self:
            ...
            if partner.phone:
                ...
                message_mail = (
                    f"Bonjour ,<br>"
                    f"Votre code de vérification est {otp_code}<br>"
                    f"Merci de ne pas répondre à ce message.<br>"
                    f"Equipe de CCBM Shop"
                )
                                                            ...
                                                            <div>
                                                                ...
                                                                <div style="margin: 16px 0px; text-align: center;">
                                                                    <a style="background-color: #875A7B; padding: 10px 20px; text-decoration: none; color: #fff; border-radius: 5px; font-size:14px;" 
                                                                        href="http://ccbme.sn/verification-code?email={self.email}">
                                                                        Vérifier mon compte
                                                                    </a>
                                                                </div>
                                                                ...
                                                                Ce code est valable pour une durée limitée. Ne le partagez avec personne.<br/><br/>
                                                                Merci,<br/>
                                                                <strong>{self.company_id.name}</strong>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="590" style="min-width: 590px; background-color: white; font-size: 11px; padding: 0px 8px 0px 8px; border-collapse:separate;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        {self.company_id.phone}
                                                            | <a style="text-decoration:none; color: #454748;" href="mailto:{self.company_id.email}">{self.company_id.email}</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
